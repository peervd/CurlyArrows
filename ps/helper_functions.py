    ...
    for vec in vectors:
        ...
        if category in ["synthetic", "equilibrium"]:
            ...
            if dx == 0:
                ...
                # For 10 degrees, tan(10°) ≈ 0.176
                slope = abs(dy) / abs(dx)
                is_horizontal = slope <= 0.176            
            ...
            has_x_difference = abs(x1 - x2) > 9  # Reasonable x-difference for horizontal
...
def remove_capital_letters(string):
    """
    Converts all capital letters in a string to lowercase letters.
    
    Args:
        string (str): The input string to convert
        
    Returns:
        str: The string with all capital letters converted to lowercase
    """
    return string.lower()